...
export function Header({ className }: SidebarProps) {
  ...
  const getLogo = () => (
    <Link href="/" className="pointer flex items-center">
      <Typography className="!text-white !text-2xl font-medium italic">
  ...
  const getAuthButtons = () => (
    <div className="flex gap-3 items-center">
      <Link
        href="https://products.dynamotech.store"
        target="_blank"
      >
        <Typography variant="p">View Products</Typography>
      </Link>
      <Link
        href="https://discord.gg/Eq4gmDm9p8"
        target="_blank"
      >
